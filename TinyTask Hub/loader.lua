...
C.MouseButton1Click:Connect(function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/juNstring/LuaProjects/main/nitro.club/anime%20fighters.lua"))()
        wait(0.5)
        game.CoreGui.loader:Destroy()
        end)
D.Name = "exitlabel"
